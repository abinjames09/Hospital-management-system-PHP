...
<div class="wrapper">
    ...
    <div class="form">
       ...
       <div class="inputfield">
          ...
          <input type="text" name="nname" class="input">
       </div> 
        <div class="inputfield">
          <label>News Paper Quantity</label>
          <input type="text" name="nquantity" class="input">
       </div>
       <div class="inputfield">
          <label>News Paper Price </label>
          <input type="text" name="nprice" class="input">
       </div> 
       ...
       <div class="inputfield">
       <button type="submit" onclick="" name="cancel" class="btn">Cancel</button>
      </div>
    </div>
</div>
</form>
...
$query= "insert into tbl_newspaper values($nid,'$nname',$nquantity,$nprice)" ;
